...
interface NFTicketInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mintNFT(string,string,string,int256,string,address)": FunctionFragment;
...
export class NFTicket extends Contract {
  ...
  functions: {
    ...
    "mintNFT(string,string,string,int256,string,address)"(
      eventName: string,
      venueName: string,
      eventDescription: string,
      numberOfTickets: BigNumberish,
